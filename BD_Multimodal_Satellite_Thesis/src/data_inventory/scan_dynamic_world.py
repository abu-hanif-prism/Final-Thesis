"""Recursive inventory scanner for Dynamic World GeoTIFF files."""
...
def scan_dynamic_world_files(dynamic_world_dir: str | Path) -> pd.DataFrame:
    """Recursively scan Dynamic World GeoTIFF files and return an inventory table."""
    records = [_build_record(path) for path in _iter_raster_files(dynamic_world_dir)]
