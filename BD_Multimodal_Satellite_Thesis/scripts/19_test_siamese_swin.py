"""Forward-pass tests for the multimodal Siamese Swin-style model."""
...
from src.models.siamese_swin import create_siamese_swin_model  # noqa: E402


def parse_args() -> argparse.Namespace:
    """Parse command-line arguments."""
    parser = argparse.ArgumentParser(description="Test multimodal Siamese Swin-style model.")
...
def main() -> None:
    ...
    for mode in modes:
        ...
        model = create_siamese_swin_model(
            output_mode=mode,
